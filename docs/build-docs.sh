...
pip3 install sphinx==5.3.0 pydata-sphinx-theme sphinx-toggleprompt nbconvert==5.6.1 nbsphinx sphinx-gallery sphinx-copybutton ipython_genutils sphinx-toggleprompt sphinx-panels===0.6.0 pandas scipy scikit-learn netcdf4 matplotlib jupyter_client ipykernel
