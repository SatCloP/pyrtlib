...
class RTEquation:
    ...
    def clearsky_absorption(p=None, tk=None, e=None, frq=None, *args, **kwargs):
        ...
        for i in range(0, nl):
            ...
            if O2AbsModel.model in ['rose03', 'rose16', 'rose17', 'rose18', 'rose20', 'rose20sd', 'rose21sd', 'rose98', 'makarov11']:
                npp, ncpp = O2AbsModel().o2abs_rosen19(pdrykpa, v, ekpa, frq)
                ncpp = 0 if O2AbsModel.model in ['rose20', 'rose20sd', 'rose21sd'] else ncpp
