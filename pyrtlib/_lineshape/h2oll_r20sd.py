...
mtx = np.vstack(
    [[11, 22.23508, 1.335e-14, 2.172, 2.74, 0.76, 13.63, 1.2, -0.033, 2.6, 0.814, blk, blk, blk, 0.435, 1.91],
     [11, 183.310087, 2.319e-12, 0.677, 3.033, 0.62, 15.01, 0.82, -0.074, 1.8, 0.136, 0.98, 0.0, 12.6, 0.413, 1.48],
...
# continuum terms
ctr = np.array([300.0, 5.919e-10, 3.0, 1.42e-08, 7.5])
