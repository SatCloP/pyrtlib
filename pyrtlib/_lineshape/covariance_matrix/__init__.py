...
nc = Dataset(os.path.join(PATH, "rose17", "Cov_parameters_Cimini_et_al_2019_V2.0.nc"))
# rose17 = np.loadtxt(os.path.join(PATH, "rose17", "Cov_parameters_Cimini_et_al_2019_V2.0.txt"),
#                     comments=['#', '$', '%'])
rose17 = np.asarray(nc.variables['Cov_p'][:])
