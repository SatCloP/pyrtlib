...
% 
% CYH      REAL FUNCTION O2ABS(TEMP,PRES,VAPDEN,FREQ)
...
% CYH *** add the following three lines ******************************

%      subroutine O2N2_xxx (pdrykpa,vx,ekpa,frq,npp,ncpp)
function [npp,ncpp] = o2n2_rosen03_xxx(pdrykpa,vx,ekpa,frq);
...
% C      LINES ARE ARRANGED 1-,1+,3-,3+,ETC. IN SPIN-ROTATION SPECTRUM
      ...
      W300 = [1.67, 1.646, 1.468, 1.449, 1.382, 1.360,...
              ...
              1.02, 1.02, 1.00, 1.00, .97, .97, .94, .94, .92, .92,...
               .89, .89, 1.64, 1.64, 1.64, 1.81, 1.81, 1.81];
