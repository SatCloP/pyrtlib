% From abh2o_list.asc
%
% This version correspond to h2o_list.asc sent by emai on  02/01/2020 
% NB: the only difference wrt h2o_sdlist_r19.m are the two coefficients W2air W2self at 22.2 GHz
% "I... found that I had neglected to put the gamma2 coefficients for 22 GHz in the h2o_sdlist.asc file. 
% Here's a corrected version. It won't make any difference near 183 GHz, but if you do calculations that include the line at 22 GHz, use this one."
%
% REFERENCES FOR MEASUREMENTS (freq, W0,D in GHZ/bar, XW, XD, A, W2) updated Jan. 2, 2020.
...
% (11) D. Turner et al., IEEE Trans. Geosci. Rem. Sens. v.47 pp.3326-37 (2009), re-adjusted for new line par. Mar. 20, 2019.
% (12) M. Koshelev (private comm., 2019)
% Other parameters from HITRAN2016.
%
%
% 2020/01/10 - Nico: first created 
...
MTX = [...
  ...
  11  183.310087  0.2319E-11  0.677  3.028  0.55  15.01  0.79  -.073    2.0   0.112  1.43   0.   18.3 0.406 1.499  ; ...% 12
