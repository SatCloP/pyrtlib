...
function [awet,adry,aO2,aN2] = ClrAbs_uncertainty_ros20sd(p,tk,e,frq);

%Nico Set the spectroscopic parameters
global perturb_mode perturb_what
AMU = AbsMod_uncertainties_perturb(perturb_mode,perturb_what,'r20sd');
%
...
%c  Compute H2O and O2 absorption (ppm) and convert to dB/km (factor) and np/km. 
    [npp,ncpp] = h2o_uncertainty_r20sd(pdrykpa,v,ekpa,frq,AMU);
