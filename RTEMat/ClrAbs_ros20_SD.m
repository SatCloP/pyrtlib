...
function [awet,adry,aO2,aN2] = ClrAbs_ros20_SD(p,tk,e,frq);
...
%c  Compute H2O and O2 absorption (ppm) and convert to dB/km (factor) and np/km. 
    %[npp,ncpp] = h2o_rosen19_sd(pdrykpa,v,ekpa,frq); modified on 2020/08/06
    [npp,ncpp] = h2o_rosen20_sd(pdrykpa,v,ekpa,frq);
