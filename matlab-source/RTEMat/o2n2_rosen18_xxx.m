...
%
% Nico: the only two differences wrt to o2n2_rosen17_xxx are:
...
% Nico 2020/02/03 *********************************************************
% 
% From: /Users/Nico/SFTWR/MPM/PWR2018/tbupdn20180723/o2abs.f
%
% References:
...
% C    add N2 term
%Nico      ncpp = ncpp + ABSN2_ros16(TEMP,PRES,FREQ);
      ncpp = ncpp + ABSN2_ros18(TEMP,PRESDA,FREQ); % modified because ABSN2_ros16 takes PRESDA in input, not PRES
