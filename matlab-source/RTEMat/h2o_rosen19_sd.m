% Nico: from /Users/Nico/SFTWR/MPM/PWR2019/SpeedDependence_183GHz/new_abh2o/abh2o_sd.f
% Nico: which, except for a comment, is the same as /Users/Nico/SFTWR/MPM/PWR2020/absorption/abh2o_sd.f
%
% C************************************
...
% C
% C  NAME- abh2o_sd.f    LANGUAGE- FORTRAN 77
% C
...
function [npp,ncpp,SUM] = h2o_rosen19_sd(pdrykpa,vx,ekpa,frq);
...
h2o_sdlist_r19
%h2o_sdlist_r20 % this is the same as h2o_sdlist_r19 but the two coefficients W2air W2self at 22.2 GHz (which were missing in h2o_sdlist_r19)
